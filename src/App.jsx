...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x4a43D73ba37E83fCd22255887D4BAc57586071d9")
  const token = useToken("0x0cadbe7Cd731f98067766242e2cE8c2C9ca16830")
  const vote = useVote("0x980b3a2CC6df915Ac41f484E7AFDdb1fdb3e29Ac")
  ...
  const mintNft = async () => {
    try {
      ...
      console.log(`🌊 Cunhado com sucesso! Olhe na OpenSea: https://testnets.opensea.io/assets/goerli/${editionDrop.getAddress()}/0`);
      setHasClaimedNFT(true)
    } catch (error) {
      setHasClaimedNFT(false)
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vindos à CthulhuDAO <br /> DAO dos fãs de <br /> H. P. Lovecraft</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por fazer parte desse clube dos seguidores de Cthulhu!</p>
        <div>
          <div>
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro 🐙 da CthulhuDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
